        ...
        { "state_name": "Tutong" }
            ...
            },
           {
...

            {
                ...
                "country_code": "0",
                "currency":"NOK",
                "states": [{ "state_name": "Bouvet Island" }]
            },
           {
...
//---------------------------B
            ...
            },
            {
                ...
                "country_code": "1345",
                "currency":"KYD",
                "states": [{ "state_name": "Grand Cayman" }]
            },
        ...
        ////------------------///
            {
                ...
                "country_code": "672",
                "currency":"AUD",
                "states": [{ "state_name": "Cocos (Keeling) Islands" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "870",
                "currency":"NZD",
                "states": [{ "state_name": "Pitcairn Island" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "672",
                "currency":"AUD",
                "states": [{ "state_name": "Norfolk Island" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "211",
                "currency":"SDD",
                "states": [{ "state_name": "Central Equatoria" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "1441",
                "currency":"BAD",
                "states": [{ "state_name": "Hamilton" }, { "state_name": "Saint George" }]
            },
            {
            ...
            // },
            {
                ...
                "country_code": "1264",
                "currency":"XAF",
                "states": [{ "state_name": "Other Provinces" }]
            },
            {
                ...
                "country_code": "246",
                "currency":"USD",
                "states": [{ "state_name": "British Indian Ocean Territory" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "61",
                "currency":"AUD",
                "states": [{ "state_name": "Christmas Island" }]
            },
            {
            ...
            },
            {
                ...
                "country_code": "0",
                "currency":"GBP",
                "states": [{ "state_name": "South Georgia" }]
            },
            {
                "country_name": "Samoa",
                "alpha2_code": "WS",
            ...
            },
            {
                ...
                "country_code": "39",
                "currency":"VAL",
                "states": [{ "state_name": "Vatican City State (Holy See)" }]
            },
            {
...
$.each(myJson.country, function (index, value) {
    // $("#country").append('<option value="' + value.country_code + '" toname="' + value.country_name + '">' + value.country_name + '</option>');

    $("#country").append('<option value="' + value.country_code +'" toname="' + value.country_name +'" alpha_code="' + value.alpha2_code + '" currency="' + value.currency + '">' + value.country_name + '</option>');
});
...
$('#country').on('change', function () {
    ...
    let country = this.options[this.selectedIndex].getAttribute("toname");

    var alpha_code = this.options[this.selectedIndex].getAttribute("alpha_code");
    var currency = this.options[this.selectedIndex].getAttribute("currency");


    for (var i = 0; i < myJson.country.length; i++) {
        if (myJson.country[i].country_code == $(this).val()) {
            $('#state').html('<option disabled > Select State/Division </option>');

            $('#country_3').html('<input id="input_3" class="form-control"  value="' + country + '" name="country" type="hidden" >');
            $('#country_4').html('<input id="input_4" class="form-control"  value="' + alpha_code + '" name="flag" type="hidden" >');
            $('#country_5').html('<input id="input_5" class="form-control"  value="' + currency + '" name="currency" type="hidden" >');
