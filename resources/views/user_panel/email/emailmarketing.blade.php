...
@section('content')
    ...
    <div class="content-wrapper">
        ...
        <section class="content">
            ...
            <div class="rdow">
                <div class="col-lg-12">
                    <h1 style="text-align: center;border-bottom:5px solid black;">Email Marketing
                        ({{ Helper::money_convert_2digit('USD', $data->where('status', 2)->count() * 0.05) }})</h1>
                </div>
                    ...
                    <div class="r">
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="card card-info" style="background: white;">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="email" name="recovery_email" class="form-control" required
                                                    php id="exampleInputEmail1" placeholder="rafat@gmail.com">
                                            </div>
