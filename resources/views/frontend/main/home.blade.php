...
@section('content')
    ...
    <section id="hero" class="d-flex justify-content-center align-items-center">
        <div class="container position-relative" data-aos="zoom-in" data-aos-delay="100">
            ...
            <h2>Just sign up with buy a course of 25$ learn and become a Mentor. After becoming Mentor earn minimum 600$ and
                more.
            </h2>
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                ...
                <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                    <h3>An opportunity to get all kinds of IT solution in a single platform.</h3>
                    <p class="fst-italic">
                        An idea can change the world and change your life. Just choose your career from unlimited ideas.
                    </p>
                    <ul>
                        <li><i class="bi bi-check-circle"></i> Signup with 25$, get unlimited course lifetime.</li>
                        <li><i class="bi bi-check-circle"></i>Free Unlimited Theme for Blog & E-Commerce or other website &
                            app for lifetime.</li>
                        <li><i class="bi bi-check-circle"></i> Buy & Sell Digital products.</li>
                        <li><i class="bi bi-check-circle"></i>After Becoming a Merchant, Sell your own products through huge
                            customers.</li>
                        <li><i class="bi bi-check-circle"></i> Dropshipping of Stocklot, Amazon, Alibaba, Shopify, Earn
                            unlimited.</li>
                        <li><i class="bi bi-check-circle"></i> Make Email & Earn 100$-250$ per Month.</li>
                        <li><i class="bi bi-check-circle"></i> Affiliate all over the world and become a hero of worldwide.
                        </li>
                        <li><i class="bi bi-check-circle"></i> Be an Entrepreneur, Lead the world.</li>
